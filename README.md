...
5. Create Mutillidae databse on phpmyadmin
...
3. After implementing **HTML Output Encoding**, When browsing **OWASP 2013 >> CSRF >> Add to your blog**, user input script is no longer executed as a code. It treated as a character.
